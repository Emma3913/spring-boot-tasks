package com.emma.tasks.domain.entities;
...
public class Task {
    ...
    public Task(UUID id, String title, String description, LocalDateTime dueDate, TaskStatus status,
            TaskPriority priority, TasksList taskList, LocalDateTime created, LocalDateTime updated) {
        this.id = id;
        this.title = title;
    ...
    public void setTasksList(TasksList taskList) {
        this.taskList = taskList;
    }
